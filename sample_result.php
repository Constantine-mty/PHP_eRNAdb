...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-lg-10 mx-auto">
            <div class="card" id="card_browser_ss" style="margin-top: 20px;margin-bottom: 20px; text-align: center;">
                <div class="card-header" style="height: 50px; color: #0362a4;font-size: larger; font-weight: bolder">
                    ...
                    Search single sample expression eRNA result
                ...
                <div class="card-body">
                <!--DataTables pos-->
                <table id="single_sample" class="table table-hover table-bordered" style="width: 100%;max-width: 100%; overflow-x: auto; table-layout: auto;">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>eRNA Region</th>
        ...
        columns: [
            { data: 'ID',
                ...
                render: function (data, type, row) {
                    ...
                    // 判断 spe 的值，生成不同的页面路径
                    if (select_specie === 'Homo sapiens') {
                        href = 'detail_erna.php';
                    } else if (select_specie === 'Mus musculus') {
